...
<template>
  <div ref="root" class="min-h-screen bg-[#0f1419]" style="overflow-x: hidden;">
    ...
    <a class="flex items-center gap-3 px-4 py-3 rounded-lg transition-all bg-gradient-to-r from-[#CBE8E4] to-[#98E7D2] text-gray-900 font-semibold" href="/deposit-record">
    ...
    <h1 class="text-white text-3xl mb-8 w-full">Deposit Record</h1>
    <div class="w-full mb-4 flex md:hidden flex-col gap-2">
    <div style="display: flex; flex-wrap: nowrap; gap: 8px; align-items: center; width: 100%;">
    <div class="relative" style="flex-shrink: 0;">
    <button class="bg-[#1a2128] border border-gray-700 text-gray-300 px-3 py-2 rounded-lg text-sm whitespace-nowrap">Status: All</button>
    </div>
    ...
    <th class="px-4 py-5 text-left text-gray-900 font-bold whitespace-nowrap tracking-wide">Transaction No.</th>
    <th class="px-4 py-5 text-left text-gray-900 font-bold whitespace-nowrap tracking-wide">Date Time</th>
    <th class="px-4 py-5 text-right text-gray-900 font-bold whitespace-nowrap tracking-wide">Deposit Amount</th>
    <th class="px-4 py-5 text-left text-gray-900 font-bold whitespace-nowrap tracking-wide">Status</th>
    <th class="px-4 py-5 text-right text-gray-900 font-bold whitespace-nowrap tracking-wide">Request Amount</th>
    <th class="px-4 py-5 text-right text-gray-900 font-bold whitespace-nowrap tracking-wide">Bonus</th>
    <th class="px-4 py-5 text-left text-gray-900 font-bold whitespace-nowrap tracking-wide">Method</th>
    <th class="px-4 py-5 text-left text-gray-900 font-bold whitespace-nowrap tracking-wide">Bank Reference</th>
    <th class="px-4 py-5 text-left text-gray-900 font-bold whitespace-nowrap tracking-wide">Deposit Time</th>
    <th class="px-4 py-5 text-right text-gray-900 font-bold whitespace-nowrap tracking-wide">Bank Charge</th>
    <th class="px-4 py-5 text-left text-gray-900 font-bold whitespace-nowrap tracking-wide">Promotion</th>
    <th class="px-4 py-5 text-left text-gray-900 font-bold whitespace-nowrap tracking-wide">Remark</th>
    </tr>
    </thead>
    <tbody>
    <tr class="border-b border-gray-800/60 bg-[#1a2128] hover:bg-[#1e2730] transition-colors">
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">DP25081201</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">2025-08-12 09:14</td>
    <td class="px-4 py-4 text-gray-300 text-right whitespace-nowrap">100,000</td>
    <td class="px-5 py-4 whitespace-nowrap">
    <span class="bg-green-900 text-green-400 text-xs px-2 py-1 rounded-full">Approved</span>
    </td>
    <td class="px-4 py-4 text-gray-300 text-right whitespace-nowrap">100,000</td>
    <td class="px-4 py-4 text-gray-300 text-right whitespace-nowrap">10,000</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">Bank</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">KB-8841</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">2025-08-12 09:18</td>
    <td class="px-4 py-4 text-gray-300 text-right whitespace-nowrap">0</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">100% Bonus</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">-</td>
    </tr>
    <tr class="border-b border-gray-800/60 bg-[#1a2128] hover:bg-[#1e2730] transition-colors">
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">DP25081105</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">2025-08-11 21:02</td>
    ...
    <td class="px-4 py-4 text-gray-300 text-right whitespace-nowrap">0</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">Bank</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">SH-2210</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">2025-08-11 21:05</td>
    <td class="px-4 py-4 text-gray-300 text-right whitespace-nowrap">0</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">-</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">-</td>
    </tr>
    <tr class="border-b border-gray-800/60 bg-[#1a2128] hover:bg-[#1e2730] transition-colors">
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">DP25081008</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">2025-08-10 13:48</td>
    <td class="px-4 py-4 text-gray-300 text-right whitespace-nowrap">200,000</td>
    <td class="px-5 py-4 whitespace-nowrap">
    <span class="text-xs px-2 py-1 rounded-full" style="background-color: rgba(161, 112, 34, 0.2); color: rgb(245, 158, 11);">Pending</span>
    </td>
    <td class="px-4 py-4 text-gray-300 text-right whitespace-nowrap">200,000</td>
    <td class="px-4 py-4 text-gray-300 text-right whitespace-nowrap">20,000</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">Crypto</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">USDT-4f1</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">-</td>
    <td class="px-4 py-4 text-gray-300 text-right whitespace-nowrap">0</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">VIP Reload</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">-</td>
    </tr>
    <tr class="border-b border-gray-800/60 bg-[#1a2128] hover:bg-[#1e2730] transition-colors">
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">DP25080902</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">2025-08-09 18:33</td>
    <td class="px-4 py-4 text-gray-300 text-right whitespace-nowrap">30,000</td>
    <td class="px-5 py-4 whitespace-nowrap">
    <span class="bg-red-900 text-red-400 text-xs px-2 py-1 rounded-full">Rejected</span>
    </td>
    <td class="px-4 py-4 text-gray-300 text-right whitespace-nowrap">30,000</td>
    <td class="px-4 py-4 text-gray-300 text-right whitespace-nowrap">0</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">Bank</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">WR-0093</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">-</td>
    <td class="px-4 py-4 text-gray-300 text-right whitespace-nowrap">0</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">-</td>
    <td class="px-4 py-4 text-gray-300 whitespace-nowrap">Name mis</td>
    </tr>
    </tbody>
    </table>
    </div>
    ...
    <div class="total-bar" style="position: fixed; right: 0px; z-index: 100; background: rgb(13, 27, 42); padding: 12px 24px; display: flex; justify-content: space-between; align-items: center; border-top: 1px solid rgba(245, 158, 11, 0.3);">
    <span style="color: rgb(245, 158, 11); font-weight: 600;">Total Deposit Amount</span>
    <span style="color: rgb(245, 158, 11); font-weight: 600;">350,000</span>
    </div>
    <MobileBottomNav />
  </div>
</template>
