...
<template>
  <div ref="root" class="min-h-screen bg-[#0f1419]" style="overflow-x: hidden;">
    ...
    <a class="flex items-center gap-3 px-4 py-3 rounded-lg transition-all bg-gradient-to-r from-[#CBE8E4] to-[#98E7D2] text-gray-900 font-semibold" href="/profit-loss">
    ...
    <span style="color: rgb(245, 158, 11); font-weight: 600;">Total P&amp;L</span>
    <span style="color: rgb(245, 158, 11); font-weight: 600;">0.00</span>
    </div>
    <MobileBottomNav />
  </div>
</template>
