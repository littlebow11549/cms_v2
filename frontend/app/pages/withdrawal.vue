...
<template>
  <div ref="root" class="min-h-screen bg-[#0f1419]" style="overflow-x: hidden;">
    ...
    <a class="flex items-center gap-3 px-4 py-3 rounded-lg transition-all bg-gradient-to-r from-[#CBE8E4] to-[#98E7D2] text-gray-900 font-semibold" href="/withdrawal">
    ...
    <h1 class="text-white text-2xl md:text-3xl mb-6 md:mb-8 w-full">Withdrawl</h1>
    <div class="bg-[#1a2128] border border-gray-800 rounded-lg p-4 md:p-8 max-w-4xl mx-auto w-full">
    <div class="mb-6 md:mb-8">
    <h2 class="text-lg md:text-xl font-semibold mb-4 pl-3" style="color: rgb(170, 229, 211); border-left: 4px solid rgb(170, 229, 211);">My Bank Accounts</h2>
    <div class="relative overflow-hidden rounded-2xl p-6 md:p-12 text-center" style="background: linear-gradient(105deg, rgb(22, 63, 52) 0%, rgb(15, 42, 35) 28%, rgb(11, 24, 21) 55%, rgb(10, 14, 18) 100%);">
    ...
    <div class="w-20 h-20 md:w-24 md:h-24 rounded-full border-2 border-dashed border-gray-600 flex items-center justify-center" style="background: rgba(26, 33, 40, 0.6);">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-credit-card w-10 h-10 md:w-12 md:h-12 text-gray-400">
    ...
    <button class="px-6 py-2 rounded-lg hover:opacity-90 transition-opacity font-semibold text-sm md:text-base" style="background: linear-gradient(rgb(247, 224, 127) 0%, rgb(239, 203, 94) 100%); color: rgb(31, 41, 55);">Add Account</button>
    </div>
    </div>
    <button class="flex items-center gap-2 text-gray-400 hover:text-white mt-4 transition-colors">
    ...
    <button class="w-full bg-gradient-to-r from-[#CBE8E4] to-[#98E7D2] text-gray-900 px-6 md:px-8 py-3 rounded-lg hover:opacity-90 transition-opacity mb-6 text-sm md:text-base font-semibold">Withdrawal Amount &amp; Password</button>
    <div class="mb-4">
    <input type="text" placeholder="₩ 10,000 ~ ₩ 9,000,000" class="w-full bg-[#0f1419] border border-gray-700 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-[#98E7D2] transition-colors" value="">
    </div>
    <div class="mb-4 relative">
    <input type="password" placeholder="* * * * * *" class="w-full bg-[#0f1419] border border-gray-700 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-[#98E7D2] transition-colors" value="">
    ...
    <button class="w-full bg-gray-600 text-white py-3 md:py-4 rounded-lg hover:opacity-90 transition-opacity font-semibold text-sm md:text-base">Submit</button>
