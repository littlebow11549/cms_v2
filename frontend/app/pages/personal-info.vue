...
<template>
  <div ref="root" class="min-h-screen bg-[#0f1419]" style="overflow-x: hidden;">
    ...
    <a class="flex items-center gap-3 px-4 py-3 rounded-lg transition-all bg-gradient-to-r from-[#CBE8E4] to-[#98E7D2] text-gray-900 font-semibold" href="/personal-info">
    ...
    <div class="flex items-center gap-2 bg-[#0f1419] border border-gray-700 rounded-lg px-4 py-3">
    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-500 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2M12 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z">
    </path>
    </svg>
    <input type="text" placeholder="Please enter your nickname" class="bg-transparent text-gray-300 flex-1 outline-none text-sm placeholder-gray-600">
    </div>
    <div class="flex items-center gap-2 bg-[#0f1419] border border-gray-700 rounded-lg px-4 py-3">
    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-500 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <span class="text-gray-300 text-sm">2008/03/03</span>
    </div>
    <div class="flex items-center gap-2 bg-[#0f1419] border border-gray-700 rounded-lg px-4 py-3">
    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-500 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <span class="text-gray-300 text-sm">xxxxxxx</span>
    </div>
    <div class="flex items-center gap-2 bg-[#0f1419] border border-gray-700 rounded-lg px-4 py-3">
    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-500 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="flex items-center gap-2 bg-[#0f1419] border border-gray-700 rounded-lg px-4 py-3 w-24 flex-shrink-0">
    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-500 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    <circle cx="12" cy="12" r="10">
    </circle>
    </svg>
    <span class="text-gray-300 text-sm">+82</span>
    </div>
    <div class="flex items-center gap-2 bg-[#0f1419] border border-gray-700 rounded-lg px-4 py-3 flex-1">
    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-500 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.18 2 2 0 0 1 3.59 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.56a16 16 0 0 0 6.29 6.29l.94-.94a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z">
    </path>
    </svg>
    <span class="text-gray-300 text-sm">123••••••••</span>
    </div>
    </div>
    </div>
    ...
    <button class="w-full py-3 rounded-lg font-semibold mb-2 bg-gradient-to-r from-[#CBE8E4] to-[#98E7D2] text-gray-900 hover:opacity-90 transition-opacity">Submit</button>
