      ...
      /* @__PURE__ */ o("main", { className: "flex-1 p-4 md:p-8", children: [
        ...
        /* @__PURE__ */ o("div", { className: "bg-[#1a2128] border border-gray-800 rounded-lg p-4 md:p-8 max-w-4xl", children: [
          /* @__PURE__ */ o("div", { className: "mb-6 md:mb-8", children: [
            /* @__PURE__ */ e("div", { className: "flex justify-end mb-4", children: /* @__PURE__ */ e("button", { className: "bg-gradient-to-r from-[#CBE8E4] to-[#98E7D2] text-gray-900 px-4 md:px-6 py-2 rounded-lg hover:opacity-90 transition-opacity text-xs md:text-sm font-semibold", children: "Deposit Amount" }) }),
