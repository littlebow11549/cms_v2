...
function j() {
  ...
  const csModal = cs && /* @__PURE__ */ o("div", { className: "fixed inset-0 z-[300] flex items-center justify-center", style: { overflowY: "auto", padding: "16px 0" }, children: [
